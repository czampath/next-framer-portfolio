...
const Card = ({
    ...
    return (
        <div
            ...
            className="border border-black/[0.2] group/canvas-card flex items-center justify-center dark:border-white/[0.2]  max-w-sm w-full mx-auto p-4 relative h-52 lg:h-[35rem] rounder-3xl"
        >
